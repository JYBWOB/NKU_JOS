...
sys_env_destroy(envid_t envid)
{
  ...
  800af9:	68 68 12 80 00       	push   $0x801268
  800afe:	6a 23                	push   $0x23
  800b00:	68 85 12 80 00       	push   $0x801285
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b7a:	68 68 12 80 00       	push   $0x801268
  800b7f:	6a 23                	push   $0x23
  800b81:	68 85 12 80 00       	push   $0x801285
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bbc:	68 68 12 80 00       	push   $0x801268
  800bc1:	6a 23                	push   $0x23
  800bc3:	68 85 12 80 00       	push   $0x801285
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bfe:	68 68 12 80 00       	push   $0x801268
  800c03:	6a 23                	push   $0x23
  800c05:	68 85 12 80 00       	push   $0x801285
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c40:	68 68 12 80 00       	push   $0x801268
  800c45:	6a 23                	push   $0x23
  800c47:	68 85 12 80 00       	push   $0x801285
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c82:	68 68 12 80 00       	push   $0x801268
  800c87:	6a 23                	push   $0x23
  800c89:	68 85 12 80 00       	push   $0x801285
...
sys_ipc_recv(void *dstva)
{
  ...
  800ce6:	68 68 12 80 00       	push   $0x801268
  800ceb:	6a 23                	push   $0x23
  800ced:	68 85 12 80 00       	push   $0x801285
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d1b:	56                   	push   %esi
  800d1c:	50                   	push   %eax
  800d1d:	68 94 12 80 00       	push   $0x801294
