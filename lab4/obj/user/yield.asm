...
sys_env_destroy(envid_t envid)
{
  ...
  800b35:	68 e8 12 80 00       	push   $0x8012e8
  800b3a:	6a 23                	push   $0x23
  800b3c:	68 05 13 80 00       	push   $0x801305
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bb6:	68 e8 12 80 00       	push   $0x8012e8
  800bbb:	6a 23                	push   $0x23
  800bbd:	68 05 13 80 00       	push   $0x801305
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bf8:	68 e8 12 80 00       	push   $0x8012e8
  800bfd:	6a 23                	push   $0x23
  800bff:	68 05 13 80 00       	push   $0x801305
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c3a:	68 e8 12 80 00       	push   $0x8012e8
  800c3f:	6a 23                	push   $0x23
  800c41:	68 05 13 80 00       	push   $0x801305
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c7c:	68 e8 12 80 00       	push   $0x8012e8
  800c81:	6a 23                	push   $0x23
  800c83:	68 05 13 80 00       	push   $0x801305
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cbe:	68 e8 12 80 00       	push   $0x8012e8
  800cc3:	6a 23                	push   $0x23
  800cc5:	68 05 13 80 00       	push   $0x801305
...
sys_ipc_recv(void *dstva)
{
  ...
  800d22:	68 e8 12 80 00       	push   $0x8012e8
  800d27:	6a 23                	push   $0x23
  800d29:	68 05 13 80 00       	push   $0x801305
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d57:	56                   	push   %esi
  800d58:	50                   	push   %eax
  800d59:	68 14 13 80 00       	push   $0x801314
  ...
  800d6a:	e8 c5 f3 ff ff       	call   800134 <vcprintf>
	cprintf("\n");
  800d6f:	c7 04 24 38 13 80 00 	movl   $0x801338,(%esp)
