...
handler(struct UTrapframe *utf)
{
  ...
  80003d:	8b 18                	mov    (%eax),%ebx
	...
	cprintf("fault %x\n", addr);
  80003f:	53                   	push   %ebx
  800040:	68 00 11 80 00       	push   $0x801100
  ...
  800068:	50                   	push   %eax
  800069:	53                   	push   %ebx
  80006a:	68 20 11 80 00       	push   $0x801120
  80006f:	6a 0f                	push   $0xf
  800071:	68 0a 11 80 00       	push   $0x80110a
  800076:	e8 92 00 00 00       	call   80010d <_panic>
	snprintf((char*) addr, 100, "this string was faulted in at %x", addr);
  80007b:	53                   	push   %ebx
  80007c:	68 4c 11 80 00       	push   $0x80114c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800129:	56                   	push   %esi
  80012a:	50                   	push   %eax
  80012b:	68 78 11 80 00       	push   $0x801178
  ...
  80013c:	e8 54 00 00 00       	call   800195 <vcprintf>
	cprintf("\n");
  800141:	c7 04 24 08 11 80 00 	movl   $0x801108,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800249:	e8 12 0c 00 00       	call   800e60 <__udivdi3>
  ...
  80028c:	e8 ff 0c 00 00       	call   800f90 <__umoddi3>
  800291:	83 c4 14             	add    $0x14,%esp
  800294:	0f be 80 9b 11 80 00 	movsbl 0x80119b(%eax),%eax
  80029b:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800356:	ff 24 85 60 12 80 00 	jmp    *0x801260(,%eax,4)
  ...
  800418:	83 f8 09             	cmp    $0x9,%eax
  80041b:	7f 0b                	jg     800428 <vprintfmt+0x145>
  80041d:	8b 14 85 c0 13 80 00 	mov    0x8013c0(,%eax,4),%edx
  800424:	85 d2                	test   %edx,%edx
  800426:	75 1b                	jne    800443 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800428:	50                   	push   %eax
  800429:	68 b3 11 80 00       	push   $0x8011b3
  80042e:	53                   	push   %ebx
  80042f:	56                   	push   %esi
  ...
  800443:	52                   	push   %edx
  800444:	68 bc 11 80 00       	push   $0x8011bc
  800449:	53                   	push   %ebx
  80044a:	56                   	push   %esi
  ...
  80046e:	b8 ac 11 80 00       	mov    $0x8011ac,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b96:	68 e8 13 80 00       	push   $0x8013e8
  800b9b:	6a 23                	push   $0x23
  800b9d:	68 05 14 80 00       	push   $0x801405
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c17:	68 e8 13 80 00       	push   $0x8013e8
  800c1c:	6a 23                	push   $0x23
  800c1e:	68 05 14 80 00       	push   $0x801405
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c59:	68 e8 13 80 00       	push   $0x8013e8
  800c5e:	6a 23                	push   $0x23
  800c60:	68 05 14 80 00       	push   $0x801405
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c9b:	68 e8 13 80 00       	push   $0x8013e8
  800ca0:	6a 23                	push   $0x23
  800ca2:	68 05 14 80 00       	push   $0x801405
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cdd:	68 e8 13 80 00       	push   $0x8013e8
  800ce2:	6a 23                	push   $0x23
  800ce4:	68 05 14 80 00       	push   $0x801405
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d1f:	68 e8 13 80 00       	push   $0x8013e8
  800d24:	6a 23                	push   $0x23
  800d26:	68 05 14 80 00       	push   $0x801405
...
sys_ipc_recv(void *dstva)
{
  ...
  800d83:	68 e8 13 80 00       	push   $0x8013e8
  800d88:	6a 23                	push   $0x23
  800d8a:	68 05 14 80 00       	push   $0x801405
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800dca:	50                   	push   %eax
  800dcb:	68 14 14 80 00       	push   $0x801414
  800dd0:	6a 23                	push   $0x23
  800dd2:	68 70 14 80 00       	push   $0x801470
  ...
  800de4:	e8 c6 fd ff ff       	call   800baf <sys_getenvid>
  800de9:	83 ec 08             	sub    $0x8,%esp
  800dec:	68 12 0e 80 00       	push   $0x800e12
  800df1:	50                   	push   %eax
  800df2:	e8 ff fe ff ff       	call   800cf6 <sys_env_set_pgfault_upcall>
  800df7:	83 c4 10             	add    $0x10,%esp
  800dfa:	85 c0                	test   %eax,%eax
  800dfc:	79 12                	jns    800e10 <set_pgfault_handler+0x74>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  800dfe:	50                   	push   %eax
  800dff:	68 44 14 80 00       	push   $0x801444
  800e04:	6a 2a                	push   $0x2a
  800e06:	68 70 14 80 00       	push   $0x801470
  800e0b:	e8 fd f2 ff ff       	call   80010d <_panic>
...
_pgfault_upcall:
  ...
  800e13:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e1a:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  800e1d:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  800e21:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  800e25:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  800e29:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  800e2c:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  800e2f:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  800e32:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  800e36:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  800e3a:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  800e3e:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  800e42:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  800e46:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB 4: Your code here.
		leal 0x2c(%esp), %esp
  800e4a:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  800e4e:	9d                   	popf   
