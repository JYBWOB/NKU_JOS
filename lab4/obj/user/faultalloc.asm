...
umain(int argc, char **argv)
{
  ...
  8000a9:	68 1c 11 80 00       	push   $0x80111c
  8000ae:	e8 48 01 00 00       	call   8001fb <cprintf>
	cprintf("%s\n", (char*)0xCafeBffe);
  8000b3:	83 c4 08             	add    $0x8,%esp
  8000b6:	68 fe bf fe ca       	push   $0xcafebffe
  8000bb:	68 1c 11 80 00       	push   $0x80111c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80013e:	56                   	push   %esi
  80013f:	50                   	push   %eax
  800140:	68 78 11 80 00       	push   $0x801178
  ...
  800151:	e8 54 00 00 00       	call   8001aa <vcprintf>
	cprintf("\n");
  800156:	c7 04 24 1e 11 80 00 	movl   $0x80111e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025e:	e8 0d 0c 00 00       	call   800e70 <__udivdi3>
  ...
  8002a1:	e8 fa 0c 00 00       	call   800fa0 <__umoddi3>
  8002a6:	83 c4 14             	add    $0x14,%esp
  8002a9:	0f be 80 9b 11 80 00 	movsbl 0x80119b(%eax),%eax
  8002b0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80036b:	ff 24 85 60 12 80 00 	jmp    *0x801260(,%eax,4)
  ...
  800432:	8b 14 85 c0 13 80 00 	mov    0x8013c0(,%eax,4),%edx
  800439:	85 d2                	test   %edx,%edx
  80043b:	75 1b                	jne    800458 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80043d:	50                   	push   %eax
  80043e:	68 b3 11 80 00       	push   $0x8011b3
  800443:	53                   	push   %ebx
  800444:	56                   	push   %esi
  ...
  800458:	52                   	push   %edx
  800459:	68 bc 11 80 00       	push   $0x8011bc
  80045e:	53                   	push   %ebx
  80045f:	56                   	push   %esi
  ...
  800483:	b8 ac 11 80 00       	mov    $0x8011ac,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bab:	68 e8 13 80 00       	push   $0x8013e8
  800bb0:	6a 23                	push   $0x23
  800bb2:	68 05 14 80 00       	push   $0x801405
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c2c:	68 e8 13 80 00       	push   $0x8013e8
  800c31:	6a 23                	push   $0x23
  800c33:	68 05 14 80 00       	push   $0x801405
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c6e:	68 e8 13 80 00       	push   $0x8013e8
  800c73:	6a 23                	push   $0x23
  800c75:	68 05 14 80 00       	push   $0x801405
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb0:	68 e8 13 80 00       	push   $0x8013e8
  800cb5:	6a 23                	push   $0x23
  800cb7:	68 05 14 80 00       	push   $0x801405
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cf2:	68 e8 13 80 00       	push   $0x8013e8
  800cf7:	6a 23                	push   $0x23
  800cf9:	68 05 14 80 00       	push   $0x801405
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d34:	68 e8 13 80 00       	push   $0x8013e8
  800d39:	6a 23                	push   $0x23
  800d3b:	68 05 14 80 00       	push   $0x801405
...
sys_ipc_recv(void *dstva)
{
  ...
  800d98:	68 e8 13 80 00       	push   $0x8013e8
  800d9d:	6a 23                	push   $0x23
  800d9f:	68 05 14 80 00       	push   $0x801405
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800dbe:	75 31                	jne    800df1 <set_pgfault_handler+0x40>
		// First time through!
  ...
  800ddf:	50                   	push   %eax
  800de0:	68 14 14 80 00       	push   $0x801414
  800de5:	6a 23                	push   $0x23
  800de7:	68 70 14 80 00       	push   $0x801470
  ...
  800df9:	e8 c6 fd ff ff       	call   800bc4 <sys_getenvid>
  800dfe:	83 ec 08             	sub    $0x8,%esp
  800e01:	68 27 0e 80 00       	push   $0x800e27
  800e06:	50                   	push   %eax
  800e07:	e8 ff fe ff ff       	call   800d0b <sys_env_set_pgfault_upcall>
  800e0c:	83 c4 10             	add    $0x10,%esp
  800e0f:	85 c0                	test   %eax,%eax
  800e11:	79 12                	jns    800e25 <set_pgfault_handler+0x74>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  800e13:	50                   	push   %eax
  800e14:	68 44 14 80 00       	push   $0x801444
  800e19:	6a 2a                	push   $0x2a
  800e1b:	68 70 14 80 00       	push   $0x801470
  800e20:	e8 fd f2 ff ff       	call   800122 <_panic>
...
_pgfault_upcall:
  ...
  800e28:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e2f:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  800e32:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  800e36:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  800e3a:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  800e3e:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  800e41:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  800e44:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  800e47:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  800e4b:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  800e4f:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  800e53:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  800e57:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  800e5b:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB 4: Your code here.
		leal 0x2c(%esp), %esp
  800e5f:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  800e63:	9d                   	popf   
