...
umain(int argc, char **argv)
{
  ...
  800064:	53                   	push   %ebx
  800065:	68 80 11 80 00       	push   $0x801180
  ...
  80007c:	50                   	push   %eax
  80007d:	53                   	push   %ebx
  80007e:	68 91 11 80 00       	push   $0x801191
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	e8 ec 0c 00 00       	call   800ee0 <__udivdi3>
  ...
  800232:	e8 d9 0d 00 00       	call   801010 <__umoddi3>
  800237:	83 c4 14             	add    $0x14,%esp
  80023a:	0f be 80 b2 11 80 00 	movsbl 0x8011b2(%eax),%eax
  800241:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002fc:	ff 24 85 80 12 80 00 	jmp    *0x801280(,%eax,4)
  ...
  8003c3:	8b 14 85 e0 13 80 00 	mov    0x8013e0(,%eax,4),%edx
  8003ca:	85 d2                	test   %edx,%edx
  8003cc:	75 1b                	jne    8003e9 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  8003ce:	50                   	push   %eax
  8003cf:	68 ca 11 80 00       	push   $0x8011ca
  8003d4:	53                   	push   %ebx
  8003d5:	56                   	push   %esi
  ...
  8003e9:	52                   	push   %edx
  8003ea:	68 d3 11 80 00       	push   $0x8011d3
  8003ef:	53                   	push   %ebx
  8003f0:	56                   	push   %esi
  ...
  800414:	b8 c3 11 80 00       	mov    $0x8011c3,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b3c:	68 08 14 80 00       	push   $0x801408
  800b41:	6a 23                	push   $0x23
  800b43:	68 25 14 80 00       	push   $0x801425
  800b48:	e8 45 03 00 00       	call   800e92 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bbd:	68 08 14 80 00       	push   $0x801408
  800bc2:	6a 23                	push   $0x23
  800bc4:	68 25 14 80 00       	push   $0x801425
  800bc9:	e8 c4 02 00 00       	call   800e92 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bff:	68 08 14 80 00       	push   $0x801408
  800c04:	6a 23                	push   $0x23
  800c06:	68 25 14 80 00       	push   $0x801425
  800c0b:	e8 82 02 00 00       	call   800e92 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c41:	68 08 14 80 00       	push   $0x801408
  800c46:	6a 23                	push   $0x23
  800c48:	68 25 14 80 00       	push   $0x801425
  800c4d:	e8 40 02 00 00       	call   800e92 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c83:	68 08 14 80 00       	push   $0x801408
  800c88:	6a 23                	push   $0x23
  800c8a:	68 25 14 80 00       	push   $0x801425
  800c8f:	e8 fe 01 00 00       	call   800e92 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cc5:	68 08 14 80 00       	push   $0x801408
  800cca:	6a 23                	push   $0x23
  800ccc:	68 25 14 80 00       	push   $0x801425
  800cd1:	e8 bc 01 00 00       	call   800e92 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d29:	68 08 14 80 00       	push   $0x801408
  800d2e:	6a 23                	push   $0x23
  800d30:	68 25 14 80 00       	push   $0x801425
  800d35:	e8 58 01 00 00       	call   800e92 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800d52:	75 12                	jne    800d66 <ipc_recv+0x24>
		r= sys_ipc_recv( (void *)UTOP);
  800d54:	83 ec 0c             	sub    $0xc,%esp
  800d57:	68 00 00 c0 ee       	push   $0xeec00000
  800d5c:	e8 a0 ff ff ff       	call   800d01 <sys_ipc_recv>
  800d61:	83 c4 10             	add    $0x10,%esp
  800d64:	eb 0c                	jmp    800d72 <ipc_recv+0x30>
	else
		r = sys_ipc_recv(pg);
  800d66:	83 ec 0c             	sub    $0xc,%esp
  800d69:	50                   	push   %eax
  800d6a:	e8 92 ff ff ff       	call   800d01 <sys_ipc_recv>
  800d6f:	83 c4 10             	add    $0x10,%esp
	if(r == 0){
  800d72:	85 c0                	test   %eax,%eax
  800d74:	75 1e                	jne    800d94 <ipc_recv+0x52>
		if( from_env_store != 0 )
  800d76:	85 f6                	test   %esi,%esi
  800d78:	74 0a                	je     800d84 <ipc_recv+0x42>
			*from_env_store = thisenv->env_ipc_from;
  800d7a:	a1 04 20 80 00       	mov    0x802004,%eax
  800d7f:	8b 40 74             	mov    0x74(%eax),%eax
  800d82:	89 06                	mov    %eax,(%esi)

		if(perm_store != 0 )
  800d84:	85 db                	test   %ebx,%ebx
  800d86:	74 1e                	je     800da6 <ipc_recv+0x64>
			*perm_store = thisenv->env_ipc_perm;
  800d88:	a1 04 20 80 00       	mov    0x802004,%eax
  800d8d:	8b 40 78             	mov    0x78(%eax),%eax
  800d90:	89 03                	mov    %eax,(%ebx)
  800d92:	eb 12                	jmp    800da6 <ipc_recv+0x64>
	}
	else{
		panic("The ipc_recv is not right, and the errno is %d\n",r);
  800d94:	50                   	push   %eax
  800d95:	68 34 14 80 00       	push   $0x801434
  800d9a:	6a 28                	push   $0x28
  800d9c:	68 b0 14 80 00       	push   $0x8014b0
  800da1:	e8 ec 00 00 00       	call   800e92 <_panic>
  ...
  800da6:	a1 04 20 80 00       	mov    0x802004,%eax
  800dab:	8b 50 70             	mov    0x70(%eax),%edx
  800dae:	85 d2                	test   %edx,%edx
  800db0:	75 14                	jne    800dc6 <ipc_recv+0x84>
		cprintf("the value is 0, the envid is %x\n", thisenv->env_id);
  800db2:	8b 40 48             	mov    0x48(%eax),%eax
  800db5:	83 ec 08             	sub    $0x8,%esp
  800db8:	50                   	push   %eax
  800db9:	68 64 14 80 00       	push   $0x801464
  800dbe:	e8 c9 f3 ff ff       	call   80018c <cprintf>
  800dc3:	83 c4 10             	add    $0x10,%esp
	return thisenv->env_ipc_value;
  800dc6:	a1 04 20 80 00       	mov    0x802004,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800de1:	8b 75 10             	mov    0x10(%ebp),%esi
	// LAB 4: Your code here.
  ...
  800de6:	75 18                	jne    800e00 <ipc_send+0x2b>
			r=sys_ipc_try_send(to_env,  val, (void*) UTOP,  perm);
  800de8:	ff 75 14             	pushl  0x14(%ebp)
  800deb:	68 00 00 c0 ee       	push   $0xeec00000
  800df0:	ff 75 0c             	pushl  0xc(%ebp)
  800df3:	57                   	push   %edi
  800df4:	e8 e5 fe ff ff       	call   800cde <sys_ipc_try_send>
  800df9:	89 c3                	mov    %eax,%ebx
  800dfb:	83 c4 10             	add    $0x10,%esp
  800dfe:	eb 12                	jmp    800e12 <ipc_send+0x3d>
		else
  ...
  800e07:	57                   	push   %edi
  800e08:	e8 d1 fe ff ff       	call   800cde <sys_ipc_try_send>
  800e0d:	89 c3                	mov    %eax,%ebx
  800e0f:	83 c4 10             	add    $0x10,%esp

		if(r <0 && r != -E_IPC_NOT_RECV){
  800e12:	89 d8                	mov    %ebx,%eax
  800e14:	c1 e8 1f             	shr    $0x1f,%eax
  800e17:	84 c0                	test   %al,%al
  800e19:	74 2a                	je     800e45 <ipc_send+0x70>
  800e1b:	83 fb f8             	cmp    $0xfffffff8,%ebx
  800e1e:	74 25                	je     800e45 <ipc_send+0x70>
			cprintf("the envid is %x\n", sys_getenvid());
  800e20:	e8 30 fd ff ff       	call   800b55 <sys_getenvid>
  800e25:	83 ec 08             	sub    $0x8,%esp
  800e28:	50                   	push   %eax
  800e29:	68 ba 14 80 00       	push   $0x8014ba
  800e2e:	e8 59 f3 ff ff       	call   80018c <cprintf>
			panic("ipc_send is error, and the errno is %d\n", r);
  800e33:	53                   	push   %ebx
  800e34:	68 88 14 80 00       	push   $0x801488
  800e39:	6a 53                	push   $0x53
  800e3b:	68 b0 14 80 00       	push   $0x8014b0
  800e40:	e8 4d 00 00 00       	call   800e92 <_panic>
		}
		else if(r == -E_IPC_NOT_RECV)
  800e45:	83 fb f8             	cmp    $0xfffffff8,%ebx
  800e48:	75 07                	jne    800e51 <ipc_send+0x7c>
			sys_yield();
  800e4a:	e8 25 fd ff ff       	call   800b74 <sys_yield>
		else break;
	}
  800e4f:	eb 93                	jmp    800de4 <ipc_send+0xf>
...
ipc_find_env(enum EnvType type)
{
  ...
  800e64:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800e67:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800e6d:	8b 52 50             	mov    0x50(%edx),%edx
  800e70:	39 ca                	cmp    %ecx,%edx
  800e72:	75 0d                	jne    800e81 <ipc_find_env+0x28>
			return envs[i].env_id;
  800e74:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800e77:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800e7c:	8b 40 48             	mov    0x48(%eax),%eax
  800e7f:	eb 0f                	jmp    800e90 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800e89:	75 d9                	jne    800e64 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e96:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800e97:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e9a:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800ea0:	e8 b0 fc ff ff       	call   800b55 <sys_getenvid>
  800ea5:	83 ec 0c             	sub    $0xc,%esp
  800ea8:	ff 75 0c             	pushl  0xc(%ebp)
  800eab:	ff 75 08             	pushl  0x8(%ebp)
  800eae:	56                   	push   %esi
  800eaf:	50                   	push   %eax
  800eb0:	68 cc 14 80 00       	push   $0x8014cc
  800eb5:	e8 d2 f2 ff ff       	call   80018c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800eba:	83 c4 18             	add    $0x18,%esp
  800ebd:	53                   	push   %ebx
  800ebe:	ff 75 10             	pushl  0x10(%ebp)
  800ec1:	e8 75 f2 ff ff       	call   80013b <vcprintf>
	cprintf("\n");
  800ec6:	c7 04 24 8f 11 80 00 	movl   $0x80118f,(%esp)
  800ecd:	e8 ba f2 ff ff       	call   80018c <cprintf>
  800ed2:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800ed5:	cc                   	int3   
  800ed6:	eb fd                	jmp    800ed5 <_panic+0x43>
