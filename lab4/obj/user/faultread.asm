	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e7:	0f be 80 08 10 80 00 	movsbl 0x801008(%eax),%eax
  8001ee:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002a9:	ff 24 85 c0 10 80 00 	jmp    *0x8010c0(,%eax,4)
  ...
  800370:	8b 14 85 20 12 80 00 	mov    0x801220(,%eax,4),%edx
  800377:	85 d2                	test   %edx,%edx
  800379:	75 1b                	jne    800396 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80037b:	50                   	push   %eax
  80037c:	68 20 10 80 00       	push   $0x801020
  800381:	53                   	push   %ebx
  800382:	56                   	push   %esi
  ...
  800396:	52                   	push   %edx
  800397:	68 29 10 80 00       	push   $0x801029
  80039c:	53                   	push   %ebx
  80039d:	56                   	push   %esi
  ...
  8003c1:	b8 19 10 80 00       	mov    $0x801019,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ae9:	68 48 12 80 00       	push   $0x801248
  800aee:	6a 23                	push   $0x23
  800af0:	68 65 12 80 00       	push   $0x801265
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b6a:	68 48 12 80 00       	push   $0x801248
  800b6f:	6a 23                	push   $0x23
  800b71:	68 65 12 80 00       	push   $0x801265
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bac:	68 48 12 80 00       	push   $0x801248
  800bb1:	6a 23                	push   $0x23
  800bb3:	68 65 12 80 00       	push   $0x801265
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bee:	68 48 12 80 00       	push   $0x801248
  800bf3:	6a 23                	push   $0x23
  800bf5:	68 65 12 80 00       	push   $0x801265
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c30:	68 48 12 80 00       	push   $0x801248
  800c35:	6a 23                	push   $0x23
  800c37:	68 65 12 80 00       	push   $0x801265
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c72:	68 48 12 80 00       	push   $0x801248
  800c77:	6a 23                	push   $0x23
  800c79:	68 65 12 80 00       	push   $0x801265
...
sys_ipc_recv(void *dstva)
{
  ...
  800cd6:	68 48 12 80 00       	push   $0x801248
  800cdb:	6a 23                	push   $0x23
  800cdd:	68 65 12 80 00       	push   $0x801265
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d0b:	56                   	push   %esi
  800d0c:	50                   	push   %eax
  800d0d:	68 74 12 80 00       	push   $0x801274
  ...
  800d1e:	e8 c5 f3 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800d23:	c7 04 24 fc 0f 80 00 	movl   $0x800ffc,(%esp)
