...
sys_env_destroy(envid_t envid)
{
  ...
  800afb:	68 48 12 80 00       	push   $0x801248
  800b00:	6a 23                	push   $0x23
  800b02:	68 65 12 80 00       	push   $0x801265
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b7c:	68 48 12 80 00       	push   $0x801248
  800b81:	6a 23                	push   $0x23
  800b83:	68 65 12 80 00       	push   $0x801265
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bbe:	68 48 12 80 00       	push   $0x801248
  800bc3:	6a 23                	push   $0x23
  800bc5:	68 65 12 80 00       	push   $0x801265
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c00:	68 48 12 80 00       	push   $0x801248
  800c05:	6a 23                	push   $0x23
  800c07:	68 65 12 80 00       	push   $0x801265
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c42:	68 48 12 80 00       	push   $0x801248
  800c47:	6a 23                	push   $0x23
  800c49:	68 65 12 80 00       	push   $0x801265
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c84:	68 48 12 80 00       	push   $0x801248
  800c89:	6a 23                	push   $0x23
  800c8b:	68 65 12 80 00       	push   $0x801265
...
sys_ipc_recv(void *dstva)
{
  ...
  800ce8:	68 48 12 80 00       	push   $0x801248
  800ced:	6a 23                	push   $0x23
  800cef:	68 65 12 80 00       	push   $0x801265
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d1d:	56                   	push   %esi
  800d1e:	50                   	push   %eax
  800d1f:	68 74 12 80 00       	push   $0x801274
