	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ce:	e8 4d 0c 00 00       	call   800e20 <__udivdi3>
  ...
  800211:	e8 3a 0d 00 00       	call   800f50 <__umoddi3>
  800216:	83 c4 14             	add    $0x14,%esp
  800219:	0f be 80 e6 10 80 00 	movsbl 0x8010e6(%eax),%eax
  800220:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002db:	ff 24 85 a0 11 80 00 	jmp    *0x8011a0(,%eax,4)
  ...
  8003a2:	8b 14 85 00 13 80 00 	mov    0x801300(,%eax,4),%edx
  8003a9:	85 d2                	test   %edx,%edx
  8003ab:	75 1b                	jne    8003c8 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  8003ad:	50                   	push   %eax
  8003ae:	68 fe 10 80 00       	push   $0x8010fe
  8003b3:	53                   	push   %ebx
  8003b4:	56                   	push   %esi
  ...
  8003c8:	52                   	push   %edx
  8003c9:	68 07 11 80 00       	push   $0x801107
  8003ce:	53                   	push   %ebx
  8003cf:	56                   	push   %esi
  ...
  8003f3:	b8 f7 10 80 00       	mov    $0x8010f7,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b1b:	68 28 13 80 00       	push   $0x801328
  800b20:	6a 23                	push   $0x23
  800b22:	68 45 13 80 00       	push   $0x801345
  800b27:	e8 aa 02 00 00       	call   800dd6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b9c:	68 28 13 80 00       	push   $0x801328
  800ba1:	6a 23                	push   $0x23
  800ba3:	68 45 13 80 00       	push   $0x801345
  800ba8:	e8 29 02 00 00       	call   800dd6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bde:	68 28 13 80 00       	push   $0x801328
  800be3:	6a 23                	push   $0x23
  800be5:	68 45 13 80 00       	push   $0x801345
  800bea:	e8 e7 01 00 00       	call   800dd6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c20:	68 28 13 80 00       	push   $0x801328
  800c25:	6a 23                	push   $0x23
  800c27:	68 45 13 80 00       	push   $0x801345
  800c2c:	e8 a5 01 00 00       	call   800dd6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c62:	68 28 13 80 00       	push   $0x801328
  800c67:	6a 23                	push   $0x23
  800c69:	68 45 13 80 00       	push   $0x801345
  800c6e:	e8 63 01 00 00       	call   800dd6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ca4:	68 28 13 80 00       	push   $0x801328
  800ca9:	6a 23                	push   $0x23
  800cab:	68 45 13 80 00       	push   $0x801345
  800cb0:	e8 21 01 00 00       	call   800dd6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d08:	68 28 13 80 00       	push   $0x801328
  800d0d:	6a 23                	push   $0x23
  800d0f:	68 45 13 80 00       	push   $0x801345
  800d14:	e8 bd 00 00 00       	call   800dd6 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d2e:	75 31                	jne    800d61 <set_pgfault_handler+0x40>
		// First time through!
		// LAB 4: Your code here.
		void* addr = (void*) (UXSTACKTOP-PGSIZE);
		r=sys_page_alloc(thisenv->env_id, addr, PTE_W|PTE_U|PTE_P);
  800d30:	a1 04 20 80 00       	mov    0x802004,%eax
  800d35:	8b 40 48             	mov    0x48(%eax),%eax
  ...
  800d4f:	50                   	push   %eax
  800d50:	68 54 13 80 00       	push   $0x801354
  800d55:	6a 23                	push   $0x23
  800d57:	68 b0 13 80 00       	push   $0x8013b0
  800d5c:	e8 75 00 00 00       	call   800dd6 <_panic>
  ...
  800d69:	e8 c6 fd ff ff       	call   800b34 <sys_getenvid>
  800d6e:	83 ec 08             	sub    $0x8,%esp
  800d71:	68 97 0d 80 00       	push   $0x800d97
  800d76:	50                   	push   %eax
  800d77:	e8 ff fe ff ff       	call   800c7b <sys_env_set_pgfault_upcall>
  800d7c:	83 c4 10             	add    $0x10,%esp
  800d7f:	85 c0                	test   %eax,%eax
  800d81:	79 12                	jns    800d95 <set_pgfault_handler+0x74>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  800d83:	50                   	push   %eax
  800d84:	68 84 13 80 00       	push   $0x801384
  800d89:	6a 2a                	push   $0x2a
  800d8b:	68 b0 13 80 00       	push   $0x8013b0
  800d90:	e8 41 00 00 00       	call   800dd6 <_panic>
...
_pgfault_upcall:
  ...
  800d98:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  800d9d:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  800d9f:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  800da2:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  800da6:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  800daa:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  800dae:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  800db1:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  800db4:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  800db7:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  800dbb:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  800dbf:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  800dc3:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  800dc7:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  800dcb:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB 4: Your code here.
		leal 0x2c(%esp), %esp
  800dcf:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  800dd3:	9d                   	popf   
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dde:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800de4:	e8 4b fd ff ff       	call   800b34 <sys_getenvid>
  800de9:	83 ec 0c             	sub    $0xc,%esp
  800dec:	ff 75 0c             	pushl  0xc(%ebp)
  800def:	ff 75 08             	pushl  0x8(%ebp)
  800df2:	56                   	push   %esi
  800df3:	50                   	push   %eax
  800df4:	68 c0 13 80 00       	push   $0x8013c0
  800df9:	e8 6d f3 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800dfe:	83 c4 18             	add    $0x18,%esp
  800e01:	53                   	push   %ebx
  800e02:	ff 75 10             	pushl  0x10(%ebp)
  800e05:	e8 10 f3 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800e0a:	c7 04 24 da 10 80 00 	movl   $0x8010da,(%esp)
  800e11:	e8 55 f3 ff ff       	call   80016b <cprintf>
  800e16:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800e19:	cc                   	int3   
  800e1a:	eb fd                	jmp    800e19 <_panic+0x43>
